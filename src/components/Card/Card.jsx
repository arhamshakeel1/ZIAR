...
export default function Card({
  ...
  return (
    <div className="group flex w-full max-w-[3400px] flex-col rounded-[1.5rem] bg-[#c9c2b1] p-2 border border-[#EFEAE1] shadow-sm transition-all duration-100 hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="mb-3 relative h-54 w-full overflow-hidden rounded-[1.2rem] bg-gray-200">
        ...
        <button 
          ...
          className="absolute top-3 right-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-black/20 text-white backdrop-blur-md transition-all hover:bg-white hover:text-black hover:scale-105"
        >
