            ...
            {loading ?
                ...
                : <div className="max-w-[1650px] mx-auto">
                    ...
                    <div className="flex text-[#ffffff] items-center justify-center gap-3 mt-11 ">
                        ...
                        <span className="text-3xl font-semibold text-[#f3efea]">
                    ...
                    <div className=" border rounded-xl border-2 border-[#9a8a6f] py-17 mt-5 mr-36 ml-36 bg-[#1e1a1a] mx-auto flex flex-col md:flex-row items-center justify-center gap-50 md:gap-45 shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-white/5">
                        ...
                        <div>
                            ...
                            <p className="text-xl ml-11 tracking-[0.3em] text-[#fffcf7] mb-3">
                                TODAY
                            </p>

                            <div className="flex items-start mb-5 mt-4">
                                <span className="text-7xl md:text-[138px] text-[#bfae93] font-bold leading-none">
                                    {weatherDatabyName?.main?.temp
                                        ? Math.round(weatherDatabyName.main.temp)
                                        : "NaN"}
                                </span>

                                <span className="text-3xl md:text-4xl font-medium text-[#d6c8b2] ml-1. mr-2 mt-2">
                                    °C
                                </span>
                            </div>

                            {/* High / Low */}
                            <div className="flex gap-11   mt-11 text-xl">
                                <span>
                                    <strong className='text-[#fffcf7]'>↑ {weatherDatabyName?.main?.temp
                                ...
                                <span className="text-[#d6c8b2]/60">
                                    ↓ <strong>{Math.floor(weatherDatabyName?.main?.temp_min)}.1°</strong>
                                </span>
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className='flex-wrap flex flex-col justify-center items-center'>
                                <h2 className="text-lg text-[#fffcf7] font-bold uppercase tracking-[0.3em]">
                                    {weatherDatabyName?.weather?.[0]?.description || "Clear Sky"}
                                </h2>

                                <p className="text-lg  text-[#d6c8b2]/60 font-semibold mt-2">
                                    Feels Like {weatherDatabyName?.main?.feels_like
                    ...
                    {/* Longitude / Latitude */}
                    <div className="grid grid-cols-2 gap-6 mt-6 ml-36 mr-36 mt-12 ">

                        {/* Longitude */}
                        <div className="border-2 border-[#9a8a6f] rounded-xl bg-[#1e1a1a] p-8 px-45 flex items-center justify-center gap-5 shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-white/5">
                    ...
                    {/* wind */}
                    <div className=" max-w-[1355px] mx-auto mt-25 mb-60 mx-auto  text-[#dcd7cf] shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-white/5">


                        <div className="border-2 border-[#9a8a6f] rounded-xl bg-[#1e1a1a] p-19">
                            ...
                            <div className="grid grid-cols-3 items-center">
                                ...
                                <div className="flex items-center justify-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm uppercase tracking-widest text-[#d6c8b2]/60">
                                            Direction
                                        </p>

                                        <p className="text-2xl font-semibold">
                                            {weatherDatabyName?.wind?.deg}°
                                        </p>
                                    </div>
                                ...
                                {/* Wind Speed */}
                                <div className="flex flex-col items-center   border-[#9a8a6f]/40">

                                    <p className="text-5x uppercase tracking-widest text-[#d6c8b2]/60">
                                        Wind Speed
                                    </p>

                                    <p className="text-9xl font-semibold mt-2">
                                        {weatherDatabyName.wind ?
                                            (weatherDatabyName?.wind?.speed).toFixed(1) : "NaN"}
